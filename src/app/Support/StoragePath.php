...
{
    /**
     * Normalize a public-storage value before it is saved to the database.
     *
     * Local files are stored as paths such as "uploads/designs/file.png".
     * External URLs are kept unchanged for backwards compatibility.
     */
    ...
    /**
     * Convert a stored path to a host-agnostic browser URL.
     */
